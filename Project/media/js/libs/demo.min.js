...
!(function (t) {
  ...
  !(function () {
    for (
      var t = window.location.search.substring(1).split("&"), e = 0;
      e < t.length;
      e++
    ) {
      var o = t[e].split("="),
        ...
        (function (e) {
          for (var o = 0, a = Object.entries(r); o < a.length; o++) {
            var l = t(a[o], 2),
              ...
              c = l[1],
              u = e.querySelector(
                '[name="settings-'.concat(i, '"]:checked')
              ).value;
            localStorage.setItem(c.localStorage, u), (n[i] = u);
          }
          window.dispatchEvent(new Event("resize")),
            new bootstrap.Offcanvas(e).hide();
        })(f);
    }),
    (function (e) {
      for (var o = 0, a = Object.entries(r); o < a.length; o++) {
        ...
        var c = e.querySelector(
          '[name="settings-'.concat(i, '"][value="').concat(n[i], '"]')
        );
        c && (c.checked = !0);
      }
    })(f));
