...
const loginAlertMail = document.getElementById("login-alert-mail")
...
// if (document.querySelector('.ticket_description-header') != undefined)
// {
//     document.querySelector('.ticket_description-header').addEventListener('click', (event) => {

//         if (document.querySelector('.ticket_description-body').style.display == 'none')
//         {
//             document.querySelector('.ticket_description-body').style.display = 'block';
//         } else {
//             document.querySelector('.ticket_description-body').style.display = 'none';
//         }
//     });
// }
